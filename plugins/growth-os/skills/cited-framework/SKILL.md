---
name: cited-framework
description: >
  Audit and optimize a brand against the CITED framework, Avik Bal's five-layer
  operating system for getting found, trusted, and chosen when machines answer
  the questions. Scores the brand across Citation Surface, Information
  Architecture, Technical Foundation, Evidence-Rich Extraction, and Demand
  Capture, finds the gaps in each layer, prescribes fixes in order, and runs the
  Citation Flywheel so the gains compound. Use when someone wants a CITED audit,
  an AI search visibility audit, a GEO or AEO readiness check, wants to know why
  AI engines do not cite their brand, or asks to make a brand CITED-optimized.
author: Avik Bal
---
